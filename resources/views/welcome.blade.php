...
<body>
    ...
    <section class="contact pr-3" id="contact">
        <div class="container">
            <div class="row">
                <h2 class="judul-town">Pertemuan dan Penugasan</h2>
            </div>
            <ul style="text-align: center">
                <br>
                <a href="{{ route('pertemuan1') }}" class="custom" target="_blank">Pertemuan 1</a><br>
                <a href="{{ route('pertemuan2') }}" class="custom" target="_blank">Pertemuan 2</a><br>
                <a href="{{ route('pertemuan3') }}" class="custom" target="_blank">Pertemuan 3</a><br>
                <a href="{{ route('pertemuan4') }}" class="custom" target="_blank">Pertemuan 4</a><br>
                <a href="{{ route('tugas1') }}" class="custom" target="_blank">Tugas 1</a><br>
                <a href="{{ route('tugas2') }}" class="custom" target="_blank">Tugas 2</a><br>
                <br>
                <br>
                <br>
            </ul>
